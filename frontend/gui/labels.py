...
tb_param_range = labels['nucleus_edit']['TB_PARAM_RANGE']
...
rb_draw_nuclei_colour_vdr = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_VDR']
rb_draw_nuclei_colour_dep = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_DEP']
rb_draw_nuclei_colour_sav = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_SAV']
rb_draw_nuclei_colour_dist = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_DIST']
rb_draw_nuclei_colour_apd = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_APD']
rb_draw_nuclei_colour_maa = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_MAA']
rb_draw_nuclei_colour_mia = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_MIA']
rb_draw_nuclei_colour_mma = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_MMA']
rb_draw_nuclei_colour_mao = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_MAO']
rb_draw_nuclei_colour_mio = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_MIO']
rb_draw_nuclei_colour_dio = labels['nucleus_edit']['RB_DRAW_NUCLEI_COLOUR_DIO']
...
img_voxel_size = labels['image_choice']['IMG_VOXEL_SIZE']
...
btn_save_stacks = labels['generic']['BTN_SAVE_STACKS']
label_sort = labels['generic']['LABEL_SORT']
label_min = labels['generic']['LABEL_MIN']
label_max = labels['generic']['LABEL_MAX']
